...
class UsersTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $arrPermissions = [
            ...
            [
                'name' => 'show sales-squad dashboard',
                'guard_name' => 'web',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
            [
                'name' => 'show banking dashboard',
                'guard_name' => 'web',
                'created_at' => date('Y-m-d H:i:s'),
                'updated_at' => date('Y-m-d H:i:s'),
            ],
        ...
        $bankAdminRole->givePermissionTo($bankAdminPermission);
        ...
        $bankAdmin->assignRole($bankAdminRole);

//sales-squad Admin
        $salesSquadAdminRole = Role::create(
            [
                'name' => 'sales-squad',
                'created_by' => 2,
            ]
        );
        $salesSquadAdminPermission = [
            ['name' => 'show sales-squad dashboard'],
            ['name' => 'manage lead'],
            ['name' => 'create lead'],
            ['name' => 'view lead'],
        ...
        $salesSquadAdminRole->givePermissionTo($salesSquadAdminPermission);
        $salesSquadAdmin = User::create(
            [
                'name' => 'Khaled',
                'email' => 'sales.squad@example.com',
                'password' => Hash::make('1234'),
                'type' => 'sales-squad',
                'default_pipeline' => 1,
                'plan' => 1,
...
//        Utility::pipeline_sales_squad($salesSquadAdmin->id);
