                            ...
                            <?php if(count($tasks) > 0): ?>
                                <?php $__currentLoopData = $tasks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="">
                                            <h5 class=" mx-5 text-success"><?php echo e($task->taskProgress()['percentage']); ?></h5>
                                            <div class="progress">
                                                <div class="progress-bar bg-<?php echo e($task->taskProgress()['color']); ?>" style="width: <?php echo e($task->taskProgress()['percentage']); ?>;"></div>
                                            </div>
                                        </td>
...
<?php /**PATH C:\xampp\htdocs\erpgo\resources\views/project_task/list.blade.php ENDPATH**/ ?>