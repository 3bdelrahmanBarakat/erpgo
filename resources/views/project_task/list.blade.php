...
{{--                                                </span>--}}
                                        ...
                                        <td class="">
                                            <h5 class=" mx-5 text-success">{{ $task->taskProgress()['percentage'] }}</h5>
                                            <div class="progress">
                                                <div class="progress-bar bg-{{ $task->taskProgress()['color'] }}" style="width: {{ $task->taskProgress()['percentage'] }};"></div>
                                            </div>
                                        </td>
